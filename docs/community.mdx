...
We have enabled [GitHub Discussions](https://github.com/openmfp/community). This is a space where you can connect with other users, ask questions, and share feedback about OpenMFP.
