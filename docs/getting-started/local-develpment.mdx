...
<img src={RegisterUserImgUrl} height="300" alt="Register User Form"/>;
</div>
...
<div style={{textAlign: 'center'}}>
<img src={OpenMFPPortalImgUrl} height="500" alt="Register User Form"/>;
</div>

### Create a Microfrontend  

Now that you are registered, you can create a new microfrontend. Follow the steps in the [Create Microfrontend Guide](create-microfrontend.mdx).
