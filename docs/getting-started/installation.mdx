...
1. **Container Runtime**  
   ...
   Ensure Docker or Podman is configured to use at least 10GB of memory.
...
Once the bootstrap process finishes, you can access the local Demo Portal at: http://localhost:8000
