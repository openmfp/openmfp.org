...
import LocalDevSetupImgUrl from '@site/static/img/local-dev-setup.png';
...
<img src={LocalDevSetupImgUrl} height="600" alt="Local Develipment Mode in the OpenMFP Portal"/>
</div>
